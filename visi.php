...
<body class="homepage">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="visi.php">Visi & Misi</a></li>
   ...
   $sql = mysql_query("SELECT * FROM visi");
    ...
    <section class="visi" id="visi">
        <div class="container">
            ...
            <div class="large-title text-center">        
                <h2 style="font-size: 20px;">VISI</h2>
                <hr>
            </div>
            <div class="row contact-wrap">
                <p class="text-center" style="white-space: pre-wrap; font-size: 16px;"><?php echo $row['visii'] ?></p>
            </div>
            <div class="large-title text-center">        
                <h2 style="font-size: 20px;">MISI</h2>
                <hr>
            </div>
            <div class="row contact-wrap">
            <p class="text-center" style="white-space: pre-wrap; font-size: 16px;"><?php echo $row['misi'] ?></p>
        </div>
        </div>
        </div><!--/.container-->
