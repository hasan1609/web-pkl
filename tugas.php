...
<body class="homepage">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="tugas.php">Tugas & Fungsi</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
   ...
   $sql = mysql_query("SELECT * FROM tugas");
    ...
    <section class="tugas" id="tugas">
        <div class="container">
            ...
            <div class="large-title text-center">        
                <h2 style="font-size: 20px;">TUGAS DAN FUNGSI UPTD PENGUJIAN KENDARAAN BERMOTOR (PKB)</h2>
                <hr>
            </div>
            <div class="row contact-wrap">
                <p style="white-space: pre-wrap; font-size: 16px;"><?php echo $row['tugas'] ?></p>
            </div>
            <div class="large-title text-center">        
                <h2 style="font-size: 20px;">DASAR HUKUM</h2>
                <hr>
            </div>
            <div class="row contact-wrap">
            <p style="white-space: pre-wrap; font-size: 16px;"><?php echo $row['fungsi'] ?></p>
        </div>
        </div>
        </div><!--/.container-->
    </section>
