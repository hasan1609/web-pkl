 ...
 ?>
  ...
  <body>
    ...
    <nav id="navbar" class="navbar navbar-default">
      ...
      $query_mysql = mysql_query("SELECT * FROM visi");
            ...
            <form class="" action="proses.php" method="post" enctype="multipart/form-data">
              <div class="col-md-10 col-lg-10 col-lg-offset-1">
                <div class="input-group input-group-lg">
                  ...
                  <h3>&nbsp;VISI</h3>
                  <textarea name="visi" cols="120" rows="4"><?php echo $data['visii'] ?></textarea>
                  <h3>&nbsp;MISI</h3>
                  <textarea name="misi" cols="120" rows="4"><?php echo $data['misi'] ?></textarea><br>
