        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-12 col-md-12">
              ...
              <td><?php echo substr($row["isi"], 0,500); ?></td>
              <td><?php echo date("d F Y", strtotime ($row["tanggal"])) ?></td>
              <td>
                <a class="view" href="lihat_berita.php?id=<?php echo $row["id_berita"]; ?>"><i class="fa fa-eye fa-2x" aria-hidden="true"></i></a>
                <a class="edit" href="edit-berita.php?id=<?php echo $row["id_berita"]; ?>"><i class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i></a>
                <a class="hapus" href="hapus-berita.php?id=<?php echo $row["id_berita"]; ?>" onclick="return confirm('Yakin ingin menghapus ?')"><i class="fa fa-trash-o fa-2x" aria-hidden="true"></i></a>
              </td>
              <?php } ?>
              </tr>
                    </table>
