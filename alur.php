...
<body>
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown active">
                            ...
                            <ul class="dropdown-menu">
                                <li class="active"><a href="alur.php">Alur</a></li>
    ...
    <div class="page-title">
        <h1>Alur Uji Kendaraan</h1>
    </div>
    <section id="alur" class="alur">
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <h3 class="text-center" style="font-size: 30px;">Hari Pertama</h3><hr>
                    <a target="blank" href="images/alur1.png">
                        <img src="images/alur1.png" alt="">
                    </a>
                </div>
                <div class="col-md-10 col-md-offset-1">
                    <h3 class="text-center" style="font-size: 30px;">Hari Kedua</h3><hr>
                    <a target="blank" href="images/alur2.png">
                        <img src="images/alur2.png" alt="">
                    </a>
                </div>
            </div>
        </div>
